...
const HeroSection = () => {
  ...
  return <section ref={sectionRef} className="relative w-full min-h-screen overflow-hidden bg-gradient-mesh">
      {/* Subtle Grid Overlay */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-start pt-36 sm:pt-32 lg:pt-40 pb-4 px-6 text-center">
        ...
        {/* Pill Badge */}
        <div className="opacity-0 animate-fade-up mb-8 inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-teal/10 to-orange/10 backdrop-blur-md border border-teal/30 animate-pulse-glow" style={{
        animationDelay: '0.1s',
        ...
        <h1 className="opacity-0 animate-fade-up text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight text-glow-teal max-w-4xl" style={{
        animationDelay: '0.3s',
        animationFillMode: 'forwards'
      }}>Make your home safe and beautiful without chaos</h1>

        {/* Subheadline - Orange Glow */}
        <p className="opacity-0 animate-fade-up mt-6 lg:mt-8 text-lg sm:text-xl lg:text-2xl font-medium text-glow-orange max-w-2xl leading-relaxed" style={{
        animationDelay: '0.5s',
        animationFillMode: 'forwards'
      }}>
        ...
        {/* CTA Button */}
        <div className="opacity-0 animate-fade-up mt-10 lg:mt-12" style={{
        animationDelay: '0.7s',
        animationFillMode: 'forwards'
      }}>
          <Button size="lg" className="btn-gradient border-0 text-primary-foreground font-bold text-lg px-10 py-7 rounded-full">
            Free Assessment
          </Button>
        </div>

        {/* Line and text container */}
        <div className="mt-10 sm:mt-16 flex flex-col items-center relative w-full h-[550px]">
          {/* Scroll-triggered glowing line */}
          <div className="w-4 sm:w-3 rounded-full absolute top-0 left-1/2 -translate-x-1/2" style={{
          ...
          <div className="absolute text-center px-6 w-full" style={{
          top: '355px'
        }}>
            <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight" style={{
            color: textLit ? 'hsl(30 95% 60%)' : 'hsl(30 95% 35%)',
            textShadow: textLit ? '0 0 15px hsl(30 95% 55% / 0.8), 0 0 30px hsl(30 95% 55% / 0.5)' : '0 0 5px hsl(30 95% 40% / 0.2)',
            ...
            <h3 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mt-2" style={{
            color: textLit ? 'hsl(168 70% 55%)' : 'hsl(168 70% 30%)',
            textShadow: textLit ? '0 0 15px hsl(168 70% 50% / 0.8), 0 0 30px hsl(168 70% 50% / 0.6), 0 0 45px hsl(168 70% 50% / 0.4)' : '0 0 5px hsl(168 70% 35% / 0.2)',
            filter: textLit ? 'blur(0px)' : 'blur(2px)',
            opacity: textLit ? 1 : 0.4,
            transition: 'all 600ms cubic-bezier(0.4, 0, 0.2, 1)',
