...
export const MobileVentsLayer: React.FC<LayerProps> = ({ progress, startProgress, endProgress }) => {
  ...
  return (
    ...
    >
      ...
      <g>
        <ellipse cx="185" cy="140" rx="8" ry="3" fill="hsl(168 40% 30%)" stroke="hsl(168 70% 50%)" strokeWidth="1.5" />
        <rect x="182" y="125" width="6" height="15" rx="1" fill="hsl(168 50% 40%)" stroke="hsl(168 80% 55%)" strokeWidth="1.5" />
        <ellipse cx="185" cy="125" rx="4" ry="1.5" fill="hsl(168 60% 50%)" stroke="hsl(168 80% 60%)" strokeWidth="1" />
      </g>
      
      {/* Simple box vent - moved up to align with pipe and toward center */}
      <g>
        <rect x="198" y="133" width="24" height="6" rx="1" fill="hsl(168 30% 25%)" stroke="hsl(168 70% 45%)" strokeWidth="1" />
        <rect x="200" y="120" width="20" height="14" rx="2" fill="hsl(168 45% 40%)" stroke="hsl(168 80% 55%)" strokeWidth="1.5" />
        <path d="M199,120 L199,114 Q199,111 202,111 L218,111 Q221,111 221,114 L221,120 Z" fill="hsl(168 50% 45%)" stroke="hsl(168 85% 60%)" strokeWidth="1.5" />
      </g>
