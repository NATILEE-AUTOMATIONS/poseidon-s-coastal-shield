...
const ImageGallery3D: React.FC<ImageGallery3DProps> = ({ progress }) => {
  ...
  // UNIFIED TIMING: Same scroll range for mobile and desktop (88% → 100%)
  // Only visual properties differ (scale, drift, easing)
  
  // Image 1 timing - UNIFIED
