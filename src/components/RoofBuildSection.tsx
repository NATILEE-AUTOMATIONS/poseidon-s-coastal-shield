...
const RoofBuildSection: React.FC = () => {
  ...
  const layers = [
    ...
    // 7. Vents - mobile: right after starter strip, desktop: after shingles gap
    { start: isMobile ? starterStripEnd + layerStep * 0.5 : starterStripEnd + layerStep * 4.5, 
      end: isMobile ? starterStripEnd + layerStep * 2 : starterStripEnd + layerStep * 5.5 },
            ...
            {/* House + Layers SVG - perfectly centered with zoom effect */}
              ...
              <div className="w-full max-w-2xl svg-container" style={{ containerType: 'inline-size' }}>
                ...
                >
                  ...
                  {/* 7. Pipe Boots & Vents */}
                  {isMobile ? (
                    <MobileVentsLayer progress={progress} startProgress={layers[6].start} endProgress={layers[6].end} isMobile={isMobile} />
                  ) : (
